...
MODEL           = feedback_plant_with_best_PID
MODULES         = feedback_plant_with_best_PID_capi.c feedback_plant_with_best_PID_data.c feedback_plant_with_best_PID_tgtconn.c rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_matrx.c rt_nonfinite.c rt_printf.c rtw_modelmap_utils.c xpc_datatype_ground.c 
MAKEFILE        = feedback_plant_with_best_PID.mk
...
MODELLIB                  = feedback_plant_with_best_PIDlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = feedback_plant_with_best_PID_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\feedback_plant_with_best_PID_slrt_rtw
