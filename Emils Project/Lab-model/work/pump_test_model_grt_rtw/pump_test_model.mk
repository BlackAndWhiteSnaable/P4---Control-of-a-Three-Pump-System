###########################################################################
## Makefile generated for Simulink model 'pump_test_model'. 
## 
## Makefile     : pump_test_model.mk
## Generated on : Mon Aug 22 13:30:41 2016
## MATLAB Coder version: 3.1 (R2016a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\pump_test_model.exe
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:\Users\basse\Desktop\work\Pump_setup\Lab-model\work
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = pump_test_model_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = pump_test_model_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\pump_test_model.exe
...
INCLUDES_BUILDINFO = $(MATLAB_ROOT)\simulink\include\sf_runtime;$(START_DIR)\pump_test_model_grt_rtw;$(START_DIR);C:\Users\basse\Desktop\work\Pump_setup\pump_curve_fits;$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common
...
DEFINES_STANDARD = -DMODEL=pump_test_model -DNUMST=2 -DNCSTATES=1 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\pump_test_model_grt_rtw\pump_test_model.c $(START_DIR)\pump_test_model_grt_rtw\pump_test_model_data.c $(START_DIR)\pump_test_model_grt_rtw\rtGetInf.c $(START_DIR)\pump_test_model_grt_rtw\rtGetNaN.c $(START_DIR)\pump_test_model_grt_rtw\rt_nonfinite.c rt_logging.c
...
OBJS = pump_test_model.obj pump_test_model_data.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_logging.obj
...
{$(START_DIR)\pump_test_model_grt_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\pump_test_model_grt_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
