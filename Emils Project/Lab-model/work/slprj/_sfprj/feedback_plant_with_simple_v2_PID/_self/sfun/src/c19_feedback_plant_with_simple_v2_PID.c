...
#include "c19_feedback_plant_with_simple_v2_PID.h"
...
static void initialize_c19_feedback_plant_with_simple_v2_PID
  (SFc19_feedback_plant_with_simple_v2_PIDInstanceStruct *chartInstance);
static void initialize_params_c19_feedback_plant_with_simple_v2_PID
  (SFc19_feedback_plant_with_simple_v2_PIDInstanceStruct *chartInstance);
static void enable_c19_feedback_plant_with_simple_v2_PID
  (SFc19_feedback_plant_with_simple_v2_PIDInstanceStruct *chartInstance);
static void disable_c19_feedback_plant_with_simple_v2_PID
  (SFc19_feedback_plant_with_simple_v2_PIDInstanceStruct *chartInstance);
static void c19_update_debugger_state_c19_feedback_plant_with_simple_v2_PID
  (SFc19_feedback_plant_with_simple_v2_PIDInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c19_feedback_plant_with_simple_v2_PID
  (SFc19_feedback_plant_with_simple_v2_PIDInstanceStruct *chartInstance);
static void set_sim_state_c19_feedback_plant_with_simple_v2_PID
  (SFc19_feedback_plant_with_simple_v2_PIDInstanceStruct *chartInstance, const
   mxArray *c19_st);
static void finalize_c19_feedback_plant_with_simple_v2_PID
  (SFc19_feedback_plant_with_simple_v2_PIDInstanceStruct *chartInstance);
static void sf_gateway_c19_feedback_plant_with_simple_v2_PID
  (SFc19_feedback_plant_with_simple_v2_PIDInstanceStruct *chartInstance);
static void mdl_start_c19_feedback_plant_with_simple_v2_PID
  (SFc19_feedback_plant_with_simple_v2_PIDInstanceStruct *chartInstance);
static void c19_chartstep_c19_feedback_plant_with_simple_v2_PID
  (SFc19_feedback_plant_with_simple_v2_PIDInstanceStruct *chartInstance);
static void initSimStructsc19_feedback_plant_with_simple_v2_PID
  (SFc19_feedback_plant_with_simple_v2_PIDInstanceStruct *chartInstance);
...
static uint8_T c19_h_emlrt_marshallIn
  (SFc19_feedback_plant_with_simple_v2_PIDInstanceStruct *chartInstance, const
   mxArray *c19_b_is_active_c19_feedback_plant_with_simple_v2_PID, const char_T *
   c19_identifier);
  ...
  (SFc19_feedback_plant_with_simple_v2_PIDInstanceStruct *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc19_feedback_plant_with_simple_v2_PID(chartInstance);
    chart_debug_initialize_data_addresses(chartInstance->S);
  }

  chartInstance->c19_sfEvent = CALL_EVENT;
  _sfTime_ = sf_get_time(chartInstance->S);
  chartInstance->c19_is_active_c19_feedback_plant_with_simple_v2_PID = 0U;
}
  ...
  (SFc19_feedback_plant_with_simple_v2_PIDInstanceStruct *chartInstance)
{
  ...
  c19_b_hoistedGlobal =
    chartInstance->c19_is_active_c19_feedback_plant_with_simple_v2_PID;
   ...
   mxArray *c19_st)
{
  ...
  *chartInstance->c19_stop = c19_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c19_is_active_c19_feedback_plant_with_simple_v2_PID =
    ...
    "is_active_c19_feedback_plant_with_simple_v2_PID", c19_u, 1)),
    "is_active_c19_feedback_plant_with_simple_v2_PID");
  sf_mex_destroy(&c19_u);
  c19_update_debugger_state_c19_feedback_plant_with_simple_v2_PID(chartInstance);
  ...
  (SFc19_feedback_plant_with_simple_v2_PIDInstanceStruct *chartInstance)
{
  ...
  chartInstance->c19_sfEvent = CALL_EVENT;
  c19_chartstep_c19_feedback_plant_with_simple_v2_PID(chartInstance);
  ...
  *c19_inData)
{
  ...
  const mxArray *c19_y = NULL;
  SFc19_feedback_plant_with_simple_v2_PIDInstanceStruct *chartInstance;
  chartInstance = (SFc19_feedback_plant_with_simple_v2_PIDInstanceStruct *)
    chartInstanceVoid;
   ...
   c19_identifier)
{
  ...
  c19_y = c19_i_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c19_b_is_active_c19_feedback_plant_with_simple_v2_PID), &c19_thisId);
  sf_mex_destroy(&c19_b_is_active_c19_feedback_plant_with_simple_v2_PID);
  return c19_y;
}
...
void sf_c19_feedback_plant_with_simple_v2_PID_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c19_feedback_plant_with_simple_v2_PID_get_post_codegen_info(void);
mxArray *sf_c19_feedback_plant_with_simple_v2_PID_get_autoinheritance_info(void)
{
...

  {
    mxArray* mxPostCodegenInfo =
      sf_c19_feedback_plant_with_simple_v2_PID_get_post_codegen_info();
...
mxArray *sf_c19_feedback_plant_with_simple_v2_PID_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c19_feedback_plant_with_simple_v2_PID_jit_fallback_info(void)
{
...
mxArray *sf_c19_feedback_plant_with_simple_v2_PID_updateBuildInfo_args_info(void)
{
...
static const mxArray
  *sf_get_sim_state_info_c19_feedback_plant_with_simple_v2_PID(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[9],T\"stop\",},{M[8],M[0],T\"is_active_c19_feedback_plant_with_simple_v2_PID\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c19_feedback_plant_with_simple_v2_PID_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c19_feedback_plant_with_simple_v2_PID(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc19_feedback_plant_with_simple_v2_PIDInstanceStruct*) chartInstanceVar
     )->S,0);
  initialize_params_c19_feedback_plant_with_simple_v2_PID
    ((SFc19_feedback_plant_with_simple_v2_PIDInstanceStruct*) chartInstanceVar);
  initialize_c19_feedback_plant_with_simple_v2_PID
    ((SFc19_feedback_plant_with_simple_v2_PIDInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c19_feedback_plant_with_simple_v2_PID(void
  *chartInstanceVar)
{
  enable_c19_feedback_plant_with_simple_v2_PID
    ((SFc19_feedback_plant_with_simple_v2_PIDInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c19_feedback_plant_with_simple_v2_PID(void
  *chartInstanceVar)
{
  disable_c19_feedback_plant_with_simple_v2_PID
    ((SFc19_feedback_plant_with_simple_v2_PIDInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c19_feedback_plant_with_simple_v2_PID(void
  *chartInstanceVar)
{
  sf_gateway_c19_feedback_plant_with_simple_v2_PID
    ((SFc19_feedback_plant_with_simple_v2_PIDInstanceStruct*) chartInstanceVar);
}

static const mxArray*
  sf_opaque_get_sim_state_c19_feedback_plant_with_simple_v2_PID(SimStruct* S)
{
  return get_sim_state_c19_feedback_plant_with_simple_v2_PID
    ((SFc19_feedback_plant_with_simple_v2_PIDInstanceStruct *)
     sf_get_chart_instance_ptr(S));    /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c19_feedback_plant_with_simple_v2_PID
  (SimStruct* S, const mxArray *st)
{
  set_sim_state_c19_feedback_plant_with_simple_v2_PID
    ((SFc19_feedback_plant_with_simple_v2_PIDInstanceStruct*)
     sf_get_chart_instance_ptr(S), st);
}

static void sf_opaque_terminate_c19_feedback_plant_with_simple_v2_PID(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc19_feedback_plant_with_simple_v2_PIDInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c19_feedback_plant_with_simple_v2_PID
      ((SFc19_feedback_plant_with_simple_v2_PIDInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc19_feedback_plant_with_simple_v2_PID
    ((SFc19_feedback_plant_with_simple_v2_PIDInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c19_feedback_plant_with_simple_v2_PID(SimStruct
  *S)
{
  int i;
...
static void mdlSetWorkWidths_c19_feedback_plant_with_simple_v2_PID(SimStruct *S)
{
...
static void mdlRTW_c19_feedback_plant_with_simple_v2_PID(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c19_feedback_plant_with_simple_v2_PID(SimStruct *S)
{
  SFc19_feedback_plant_with_simple_v2_PIDInstanceStruct *chartInstance;
  chartInstance = (SFc19_feedback_plant_with_simple_v2_PIDInstanceStruct *)
    utMalloc(sizeof(SFc19_feedback_plant_with_simple_v2_PIDInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c19_feedback_plant_with_simple_v2_PID;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c19_feedback_plant_with_simple_v2_PID;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c19_feedback_plant_with_simple_v2_PID;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c19_feedback_plant_with_simple_v2_PID;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c19_feedback_plant_with_simple_v2_PID;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c19_feedback_plant_with_simple_v2_PID;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c19_feedback_plant_with_simple_v2_PID;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c19_feedback_plant_with_simple_v2_PID;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c19_feedback_plant_with_simple_v2_PID;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c19_feedback_plant_with_simple_v2_PID;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c19_feedback_plant_with_simple_v2_PID;
  ...
  mdl_start_c19_feedback_plant_with_simple_v2_PID(chartInstance);
}

void c19_feedback_plant_with_simple_v2_PID_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c19_feedback_plant_with_simple_v2_PID(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c19_feedback_plant_with_simple_v2_PID(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c19_feedback_plant_with_simple_v2_PID(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c19_feedback_plant_with_simple_v2_PID_method_dispatcher.\n"
