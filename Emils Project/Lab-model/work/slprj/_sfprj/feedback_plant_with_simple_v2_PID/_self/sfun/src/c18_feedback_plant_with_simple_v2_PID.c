...
#include "feedback_plant_with_simple_v2_PID_sfun.h"
#include "c18_feedback_plant_with_simple_v2_PID.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "feedback_plant_with_simple_v2_PID_sfun_debug_macros.h"
...
static void initialize_c18_feedback_plant_with_simple_v2_PID
  (SFc18_feedback_plant_with_simple_v2_PIDInstanceStruct *chartInstance);
static void initialize_params_c18_feedback_plant_with_simple_v2_PID
  (SFc18_feedback_plant_with_simple_v2_PIDInstanceStruct *chartInstance);
static void enable_c18_feedback_plant_with_simple_v2_PID
  (SFc18_feedback_plant_with_simple_v2_PIDInstanceStruct *chartInstance);
static void disable_c18_feedback_plant_with_simple_v2_PID
  (SFc18_feedback_plant_with_simple_v2_PIDInstanceStruct *chartInstance);
static void c18_update_debugger_state_c18_feedback_plant_with_simple_v2_PID
  (SFc18_feedback_plant_with_simple_v2_PIDInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c18_feedback_plant_with_simple_v2_PID
  (SFc18_feedback_plant_with_simple_v2_PIDInstanceStruct *chartInstance);
static void set_sim_state_c18_feedback_plant_with_simple_v2_PID
  (SFc18_feedback_plant_with_simple_v2_PIDInstanceStruct *chartInstance, const
   mxArray *c18_st);
static void finalize_c18_feedback_plant_with_simple_v2_PID
  (SFc18_feedback_plant_with_simple_v2_PIDInstanceStruct *chartInstance);
static void sf_gateway_c18_feedback_plant_with_simple_v2_PID
  (SFc18_feedback_plant_with_simple_v2_PIDInstanceStruct *chartInstance);
static void mdl_start_c18_feedback_plant_with_simple_v2_PID
  (SFc18_feedback_plant_with_simple_v2_PIDInstanceStruct *chartInstance);
static void c18_chartstep_c18_feedback_plant_with_simple_v2_PID
  (SFc18_feedback_plant_with_simple_v2_PIDInstanceStruct *chartInstance);
static void initSimStructsc18_feedback_plant_with_simple_v2_PID
  (SFc18_feedback_plant_with_simple_v2_PIDInstanceStruct *chartInstance);
...
static uint8_T c18_h_emlrt_marshallIn
  (SFc18_feedback_plant_with_simple_v2_PIDInstanceStruct *chartInstance, const
   mxArray *c18_b_is_active_c18_feedback_plant_with_simple_v2_PID, const char_T *
   c18_identifier);
  ...
  (SFc18_feedback_plant_with_simple_v2_PIDInstanceStruct *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc18_feedback_plant_with_simple_v2_PID(chartInstance);
    chart_debug_initialize_data_addresses(chartInstance->S);
  }

  chartInstance->c18_sfEvent = CALL_EVENT;
  _sfTime_ = sf_get_time(chartInstance->S);
  chartInstance->c18_is_active_c18_feedback_plant_with_simple_v2_PID = 0U;
}
  ...
  (SFc18_feedback_plant_with_simple_v2_PIDInstanceStruct *chartInstance)
{
  ...
  c18_b_hoistedGlobal =
    chartInstance->c18_is_active_c18_feedback_plant_with_simple_v2_PID;
   ...
   mxArray *c18_st)
{
  ...
  *chartInstance->c18_stop = c18_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c18_is_active_c18_feedback_plant_with_simple_v2_PID =
    ...
    "is_active_c18_feedback_plant_with_simple_v2_PID", c18_u, 1)),
    "is_active_c18_feedback_plant_with_simple_v2_PID");
  sf_mex_destroy(&c18_u);
  c18_update_debugger_state_c18_feedback_plant_with_simple_v2_PID(chartInstance);
  ...
  (SFc18_feedback_plant_with_simple_v2_PIDInstanceStruct *chartInstance)
{
  ...
  chartInstance->c18_sfEvent = CALL_EVENT;
  c18_chartstep_c18_feedback_plant_with_simple_v2_PID(chartInstance);
  ...
  *c18_inData)
{
  ...
  const mxArray *c18_y = NULL;
  SFc18_feedback_plant_with_simple_v2_PIDInstanceStruct *chartInstance;
  chartInstance = (SFc18_feedback_plant_with_simple_v2_PIDInstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c18_feedback_plant_with_simple_v2_PID_get_eml_resolved_functions_info(void)
{
   ...
   c18_identifier)
{
  ...
  c18_y = c18_i_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c18_b_is_active_c18_feedback_plant_with_simple_v2_PID), &c18_thisId);
  sf_mex_destroy(&c18_b_is_active_c18_feedback_plant_with_simple_v2_PID);
  return c18_y;
}
...
void sf_c18_feedback_plant_with_simple_v2_PID_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c18_feedback_plant_with_simple_v2_PID_get_post_codegen_info(void);
mxArray *sf_c18_feedback_plant_with_simple_v2_PID_get_autoinheritance_info(void)
{
...

  {
    mxArray* mxPostCodegenInfo =
      sf_c18_feedback_plant_with_simple_v2_PID_get_post_codegen_info();
...
mxArray *sf_c18_feedback_plant_with_simple_v2_PID_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c18_feedback_plant_with_simple_v2_PID_jit_fallback_info(void)
{
...
mxArray *sf_c18_feedback_plant_with_simple_v2_PID_updateBuildInfo_args_info(void)
{
...
static const mxArray
  *sf_get_sim_state_info_c18_feedback_plant_with_simple_v2_PID(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[9],T\"stop\",},{M[8],M[0],T\"is_active_c18_feedback_plant_with_simple_v2_PID\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c18_feedback_plant_with_simple_v2_PID_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc18_feedback_plant_with_simple_v2_PIDInstanceStruct *chartInstance =
      (SFc18_feedback_plant_with_simple_v2_PIDInstanceStruct *)
...
static void sf_opaque_initialize_c18_feedback_plant_with_simple_v2_PID(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc18_feedback_plant_with_simple_v2_PIDInstanceStruct*) chartInstanceVar
     )->S,0);
  initialize_params_c18_feedback_plant_with_simple_v2_PID
    ((SFc18_feedback_plant_with_simple_v2_PIDInstanceStruct*) chartInstanceVar);
  initialize_c18_feedback_plant_with_simple_v2_PID
    ((SFc18_feedback_plant_with_simple_v2_PIDInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c18_feedback_plant_with_simple_v2_PID(void
  *chartInstanceVar)
{
  enable_c18_feedback_plant_with_simple_v2_PID
    ((SFc18_feedback_plant_with_simple_v2_PIDInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c18_feedback_plant_with_simple_v2_PID(void
  *chartInstanceVar)
{
  disable_c18_feedback_plant_with_simple_v2_PID
    ((SFc18_feedback_plant_with_simple_v2_PIDInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c18_feedback_plant_with_simple_v2_PID(void
  *chartInstanceVar)
{
  sf_gateway_c18_feedback_plant_with_simple_v2_PID
    ((SFc18_feedback_plant_with_simple_v2_PIDInstanceStruct*) chartInstanceVar);
}

static const mxArray*
  sf_opaque_get_sim_state_c18_feedback_plant_with_simple_v2_PID(SimStruct* S)
{
  return get_sim_state_c18_feedback_plant_with_simple_v2_PID
    ((SFc18_feedback_plant_with_simple_v2_PIDInstanceStruct *)
     sf_get_chart_instance_ptr(S));    /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c18_feedback_plant_with_simple_v2_PID
  (SimStruct* S, const mxArray *st)
{
  set_sim_state_c18_feedback_plant_with_simple_v2_PID
    ((SFc18_feedback_plant_with_simple_v2_PIDInstanceStruct*)
     sf_get_chart_instance_ptr(S), st);
}

static void sf_opaque_terminate_c18_feedback_plant_with_simple_v2_PID(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc18_feedback_plant_with_simple_v2_PIDInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_feedback_plant_with_simple_v2_PID_optimization_info();
    }

    finalize_c18_feedback_plant_with_simple_v2_PID
      ((SFc18_feedback_plant_with_simple_v2_PIDInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc18_feedback_plant_with_simple_v2_PID
    ((SFc18_feedback_plant_with_simple_v2_PIDInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c18_feedback_plant_with_simple_v2_PID(SimStruct
  *S)
{
  int i;
...
static void mdlSetWorkWidths_c18_feedback_plant_with_simple_v2_PID(SimStruct *S)
{
  /* Set overwritable ports for inplace optimization */
  ssMdlUpdateIsEmpty(S, 1);
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
      load_feedback_plant_with_simple_v2_PID_optimization_info
...
static void mdlRTW_c18_feedback_plant_with_simple_v2_PID(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c18_feedback_plant_with_simple_v2_PID(SimStruct *S)
{
  SFc18_feedback_plant_with_simple_v2_PIDInstanceStruct *chartInstance;
  chartInstance = (SFc18_feedback_plant_with_simple_v2_PIDInstanceStruct *)
    utMalloc(sizeof(SFc18_feedback_plant_with_simple_v2_PIDInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c18_feedback_plant_with_simple_v2_PID;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c18_feedback_plant_with_simple_v2_PID;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c18_feedback_plant_with_simple_v2_PID;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c18_feedback_plant_with_simple_v2_PID;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c18_feedback_plant_with_simple_v2_PID;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c18_feedback_plant_with_simple_v2_PID;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c18_feedback_plant_with_simple_v2_PID;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c18_feedback_plant_with_simple_v2_PID;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c18_feedback_plant_with_simple_v2_PID;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c18_feedback_plant_with_simple_v2_PID;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c18_feedback_plant_with_simple_v2_PID;
  ...
  mdl_start_c18_feedback_plant_with_simple_v2_PID(chartInstance);
}

void c18_feedback_plant_with_simple_v2_PID_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c18_feedback_plant_with_simple_v2_PID(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c18_feedback_plant_with_simple_v2_PID(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c18_feedback_plant_with_simple_v2_PID(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c18_feedback_plant_with_simple_v2_PID_method_dispatcher.\n"
