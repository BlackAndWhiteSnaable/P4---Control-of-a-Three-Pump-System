...
static void initialize_c18_feedback_plant(SFc18_feedback_plantInstanceStruct
  *chartInstance);
static void initialize_params_c18_feedback_plant
  (SFc18_feedback_plantInstanceStruct *chartInstance);
static void enable_c18_feedback_plant(SFc18_feedback_plantInstanceStruct
  *chartInstance);
static void disable_c18_feedback_plant(SFc18_feedback_plantInstanceStruct
  *chartInstance);
static void c18_update_debugger_state_c18_feedback_plant
  (SFc18_feedback_plantInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c18_feedback_plant
  (SFc18_feedback_plantInstanceStruct *chartInstance);
static void set_sim_state_c18_feedback_plant(SFc18_feedback_plantInstanceStruct *
  chartInstance, const mxArray *c18_st);
static void finalize_c18_feedback_plant(SFc18_feedback_plantInstanceStruct
  *chartInstance);
static void sf_gateway_c18_feedback_plant(SFc18_feedback_plantInstanceStruct
  *chartInstance);
static void mdl_start_c18_feedback_plant(SFc18_feedback_plantInstanceStruct
  *chartInstance);
static void c18_chartstep_c18_feedback_plant(SFc18_feedback_plantInstanceStruct *
  chartInstance);
static void initSimStructsc18_feedback_plant(SFc18_feedback_plantInstanceStruct *
  chartInstance);
...
static const mxArray *c18_sf_marshallOut(void *chartInstanceVoid, void
  *c18_inData);
static real_T c18_emlrt_marshallIn(SFc18_feedback_plantInstanceStruct
  *chartInstance, const mxArray *c18_b_stop, const char_T *c18_identifier);
static real_T c18_b_emlrt_marshallIn(SFc18_feedback_plantInstanceStruct
...
static void c18_c_emlrt_marshallIn(SFc18_feedback_plantInstanceStruct
  *chartInstance, const mxArray *c18_u, const emlrtMsgIdentifier *c18_parentId,
  char_T c18_y_data[], int32_T c18_y_sizes[2]);
...
static const mxArray *c18_e_sf_marshallOut(void *chartInstanceVoid, char_T
  c18_inData_data[], int32_T c18_inData_sizes[2]);
static void c18_d_emlrt_marshallIn(SFc18_feedback_plantInstanceStruct
  *chartInstance, const mxArray *c18_u, const emlrtMsgIdentifier *c18_parentId,
  char_T c18_y_data[], int32_T c18_y_sizes[2]);
...
static const mxArray *c18_f_sf_marshallOut(void *chartInstanceVoid, real_T
  c18_inData_data[], int32_T c18_inData_sizes[2]);
static void c18_e_emlrt_marshallIn(SFc18_feedback_plantInstanceStruct
  *chartInstance, const mxArray *c18_u, const emlrtMsgIdentifier *c18_parentId,
  real_T c18_y_data[], int32_T c18_y_sizes[2]);
...
static const mxArray *c18_g_sf_marshallOut(void *chartInstanceVoid, void
  *c18_inData);
static void c18_f_emlrt_marshallIn(SFc18_feedback_plantInstanceStruct
  *chartInstance, const mxArray *c18_u, const emlrtMsgIdentifier *c18_parentId,
  uint8_T c18_y[124]);
...
static const mxArray *c18_h_sf_marshallOut(void *chartInstanceVoid, void
  *c18_inData);
static int32_T c18_g_emlrt_marshallIn(SFc18_feedback_plantInstanceStruct
  *chartInstance, const mxArray *c18_u, const emlrtMsgIdentifier *c18_parentId);
static void c18_f_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c18_mxArrayInData, const char_T *c18_varName, void *c18_outData);
static uint8_T c18_h_emlrt_marshallIn(SFc18_feedback_plantInstanceStruct
  *chartInstance, const mxArray *c18_b_is_active_c18_feedback_plant, const
  char_T *c18_identifier);
static uint8_T c18_i_emlrt_marshallIn(SFc18_feedback_plantInstanceStruct
  *chartInstance, const mxArray *c18_u, const emlrtMsgIdentifier *c18_parentId);
static void init_dsm_address_info(SFc18_feedback_plantInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc18_feedback_plantInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc18_feedback_plant(chartInstance);
    chart_debug_initialize_data_addresses(chartInstance->S);
  }

  chartInstance->c18_sfEvent = CALL_EVENT;
  _sfTime_ = sf_get_time(chartInstance->S);
  chartInstance->c18_is_active_c18_feedback_plant = 0U;
}
  ...
  (SFc18_feedback_plantInstanceStruct *chartInstance)
{
  ...
  c18_b_hoistedGlobal = chartInstance->c18_is_active_c18_feedback_plant;
  ...
  chartInstance, const mxArray *c18_st)
{
  ...
  *chartInstance->c18_stop = c18_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c18_is_active_c18_feedback_plant = c18_h_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell("is_active_c18_feedback_plant",
       c18_u, 1)), "is_active_c18_feedback_plant");
  sf_mex_destroy(&c18_u);
  c18_update_debugger_state_c18_feedback_plant(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c18_sfEvent = CALL_EVENT;
  c18_chartstep_c18_feedback_plant(chartInstance);
  ...
  *c18_inData)
{
  ...
  const mxArray *c18_y = NULL;
  SFc18_feedback_plantInstanceStruct *chartInstance;
  chartInstance = (SFc18_feedback_plantInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c18_feedback_plant_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c18_identifier)
{
  ...
  c18_y = c18_i_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c18_b_is_active_c18_feedback_plant), &c18_thisId);
  sf_mex_destroy(&c18_b_is_active_c18_feedback_plant);
  return c18_y;
}
...
void sf_c18_feedback_plant_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c18_feedback_plant_get_post_codegen_info(void);
mxArray *sf_c18_feedback_plant_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c18_feedback_plant_get_post_codegen_info();
...
mxArray *sf_c18_feedback_plant_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c18_feedback_plant_jit_fallback_info(void)
{
...
mxArray *sf_c18_feedback_plant_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c18_feedback_plant(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[9],T\"stop\",},{M[8],M[0],T\"is_active_c18_feedback_plant\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c18_feedback_plant_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc18_feedback_plantInstanceStruct *chartInstance =
      (SFc18_feedback_plantInstanceStruct *)sf_get_chart_instance_ptr(S);
...
static void sf_opaque_initialize_c18_feedback_plant(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc18_feedback_plantInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c18_feedback_plant((SFc18_feedback_plantInstanceStruct*)
    chartInstanceVar);
  initialize_c18_feedback_plant((SFc18_feedback_plantInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c18_feedback_plant(void *chartInstanceVar)
{
  enable_c18_feedback_plant((SFc18_feedback_plantInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c18_feedback_plant(void *chartInstanceVar)
{
  disable_c18_feedback_plant((SFc18_feedback_plantInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c18_feedback_plant(void *chartInstanceVar)
{
  sf_gateway_c18_feedback_plant((SFc18_feedback_plantInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c18_feedback_plant(SimStruct* S)
{
  return get_sim_state_c18_feedback_plant((SFc18_feedback_plantInstanceStruct *)
    sf_get_chart_instance_ptr(S));     /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c18_feedback_plant(SimStruct* S, const
  mxArray *st)
{
  set_sim_state_c18_feedback_plant((SFc18_feedback_plantInstanceStruct*)
    sf_get_chart_instance_ptr(S), st);
}

static void sf_opaque_terminate_c18_feedback_plant(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc18_feedback_plantInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_feedback_plant_optimization_info();
    }

    finalize_c18_feedback_plant((SFc18_feedback_plantInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc18_feedback_plant((SFc18_feedback_plantInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c18_feedback_plant(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c18_feedback_plant(SimStruct *S)
{
...
static void mdlRTW_c18_feedback_plant(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c18_feedback_plant(SimStruct *S)
{
  SFc18_feedback_plantInstanceStruct *chartInstance;
  chartInstance = (SFc18_feedback_plantInstanceStruct *)utMalloc(sizeof
    (SFc18_feedback_plantInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc18_feedback_plantInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 1;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c18_feedback_plant;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c18_feedback_plant;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c18_feedback_plant;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c18_feedback_plant;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c18_feedback_plant;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c18_feedback_plant;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c18_feedback_plant;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c18_feedback_plant;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c18_feedback_plant;
  chartInstance->chartInfo.mdlStart = mdlStart_c18_feedback_plant;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c18_feedback_plant;
  ...
  mdl_start_c18_feedback_plant(chartInstance);
}

void c18_feedback_plant_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c18_feedback_plant(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c18_feedback_plant(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c18_feedback_plant(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c18_feedback_plant_method_dispatcher.\n"
