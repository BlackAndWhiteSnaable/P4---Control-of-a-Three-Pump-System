...
MODEL           = feedback_plant_with_simple_v2_PID
MODULES         = feedback_plant_with_simple_v2_PID_capi.c feedback_plant_with_simple_v2_PID_data.c feedback_plant_with_simple_v2_PID_tgtconn.c rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_matrx.c rt_nonfinite.c rt_printf.c rtw_modelmap_utils.c xpc_datatype_ground.c 
MAKEFILE        = feedback_plant_with_simple_v2_PID.mk
...
S_FUNCTIONS     = adnipcim.c danipcim.c xpcionim.c
S_FUNCTIONS_LIB = 
NUMST           = 2
TID01EQ         = 1
NCSTATES        = 1
...
MULTITASKING    = 0
EXT_MODE        = 0
MEX_OPT_FILE    = -f "C:\Users\basse\AppData\Roaming\MathWorks\MATLAB\R2016a\mex_C_win64.xml"
...
MODELLIB                  = feedback_plant_with_simple_v2_PIDlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = feedback_plant_with_simple_v2_PID_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\feedback_plant_with_simple_v2_PID_slrt_rtw
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)
MATLAB_INCLUDES = $(MATLAB_INCLUDES);C:\Users\basse\Desktop\work\Pump_setup\Lab-model\plant
