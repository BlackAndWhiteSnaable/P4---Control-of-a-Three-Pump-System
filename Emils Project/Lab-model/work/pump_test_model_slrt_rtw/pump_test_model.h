...
#define rtmGetRTWSolverInfo(rtm)       &((rtm)->solverInfo)
#define rtModel_pump_test_model        RT_MODEL_pump_test_model_T

/* Definition for use in the target main file */
#define pump_test_model_rtModel        RT_MODEL_pump_test_model_T
...
typedef struct {
  real_T PID_Ref;                      /* '<Root>/Rate Transition' */
  real_T PID_Error;                    /* '<Root>/Sum' */
  ...
  real_T req_flow;                     /* '<Root>/valve_CV_esti_Test' */
  real_T cost_power_3_w_sat;           /* '<Root>/cost_power_3' */
  real_T cost_power_2_w_sat;           /* '<Root>/cost_power_2' */
  real_T cost_power_1_w_sat;           /* '<Root>/cost_power_1' */
...
typedef struct {
  ...
  real_T Signalbus[8];                 /* '<Root>/Signal bus' */
} ExtY_pump_test_model_T;

/* Backward compatible GRT Identifiers */
#define rtB                            pump_test_model_B
#define BlockIO                        B_pump_test_model_T
#define rtU                            pump_test_model_U
#define ExternalInputs                 ExtU_pump_test_model_T
#define rtX                            pump_test_model_X
#define ContinuousStates               X_pump_test_model_T
#define rtXdot                         pump_test_model_XDot
#define StateDerivatives               XDot_pump_test_model_T
#define tXdis                          pump_test_model_XDis
#define StateDisabled                  XDis_pump_test_model_T
#define rtY                            pump_test_model_Y
#define ExternalOutputs                ExtY_pump_test_model_T
#define rtP                            pump_test_model_P
#define Parameters                     P_pump_test_model_T
#define rtDWork                        pump_test_model_DW
#define D_Work                         DW_pump_test_model_T
...
extern void pump_test_model_output(void);
extern void pump_test_model_update(void);
extern void pump_test_model_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern pump_test_model_rtModel *pump_test_model(void);
...
extern const rtwCAPI_ModelMappingStaticInfo*
  pump_test_model_GetCAPIStaticMap(void);
 ...
 * '<S7>'   : 'pump_test_model/PID Controller/Clamping circuit'
 */
