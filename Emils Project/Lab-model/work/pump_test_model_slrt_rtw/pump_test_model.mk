...
MODEL           = pump_test_model
MODULES         = pump_test_model_capi.c pump_test_model_data.c pump_test_model_tgtconn.c rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_nonfinite.c rtw_modelmap_utils.c xpc_datatype_ground.c 
...
MODELLIB                  = pump_test_modellib.lib
MODELREF_LINK_LIBS        = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\pump_test_model_slrt_rtw
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)
MATLAB_INCLUDES = $(MATLAB_INCLUDES);C:\Users\basse\Desktop\work\Pump_setup\pump_curve_fits
