...
MODULES         = feedback_plant_capi.c feedback_plant_data.c feedback_plant_tgtconn.c rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_matrx.c rt_nonfinite.c rt_printf.c rtw_modelmap_utils.c xpc_datatype_ground.c 
...
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = feedback_plant_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\feedback_plant_slrt_rtw
