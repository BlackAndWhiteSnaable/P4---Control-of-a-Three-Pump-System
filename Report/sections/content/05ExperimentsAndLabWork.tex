...
\todo[color=05ExperimentsAndLabWork]{yes -Daniel wait, we do later, no?}

Instead of relying on performance curves provided by the pump manufacturer,
the pump will be run in situ \todo{"situ"? I think something went missing here}, 
...
application in real-time. \todo{is it necessary to describe this and data acquisition?}
