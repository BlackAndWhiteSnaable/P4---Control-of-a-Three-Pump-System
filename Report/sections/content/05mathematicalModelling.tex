...
The data was used to determine the pump curves, and to approximate models for the curves.
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.8\textwidth]{figures/05mathematicalModelling/measuredPower.pdf}
	\vspace{-5mm}
...
within a certain degree of error, and that we would be able to further test.
...
Fitted Curves can be seen in Figure
