...
\end{figure}
\todo[color=04mathematicalModelling]{either we don't have numbers on the axes or the actually mean something. Also this figure doesn't have a single curve, just connected data points ;)}
