...
static const rtwCAPI_Signals rtBlockSignals[] = {
   ...
   */
  { 0, 0, TARGET_STRING("%2WP02"),
    TARGET_STRING(""), 0, 0, 0, 0, 0 },

  { 1, 0, TARGET_STRING("%2signal"),
    TARGET_STRING("CV01_input"), 0, 0, 0, 0, 1 },
  ...
  { 24, 0, TARGET_STRING("Stair Generator/Model/Clock"),
    TARGET_STRING(""), 0, 0, 0, 0, 0 },

  { 25, 0, TARGET_STRING("Stair Generator/Model/Derivative"),
    TARGET_STRING(""), 0, 0, 0, 0, 0 },

  { 26, 0, TARGET_STRING("Stair Generator/Model/Look-Up Table"),
    TARGET_STRING(""), 0, 0, 0, 0, 0 },
...
static void* rtDataAddrMap[] = {
  &Pump2Test_B.uWP02,                  /* 0: Signal */
  (void *) &Pump2Test_ConstB.CV01_input,/* 1: Signal */
  &Pump2Test_B.CV01,                   /* 2: Signal */
  &Pump2Test_B.DPT01,                  /* 3: Signal */
  &Pump2Test_B.LMGC1,                  /* 4: Signal */
  &Pump2Test_B.LMGP1,                  /* 5: Signal */
  &Pump2Test_B.LMGV1,                  /* 6: Signal */
  &Pump2Test_B.MFM01,                  /* 7: Signal */
  &Pump2Test_B.PT01,                   /* 8: Signal */
  &Pump2Test_B.WP01,                   /* 9: Signal */
  &Pump2Test_B.DPT02,                  /* 10: Signal */
  &Pump2Test_B.LMGC2,                  /* 11: Signal */
  &Pump2Test_B.LMGP2,                  /* 12: Signal */
  &Pump2Test_B.LMGV2,                  /* 13: Signal */
  &Pump2Test_B.MFM02,                  /* 14: Signal */
  &Pump2Test_B.PT02,                   /* 15: Signal */
  &Pump2Test_B.WP02,                   /* 16: Signal */
  &Pump2Test_B.DPT03,                  /* 17: Signal */
  &Pump2Test_B.LMGC3,                  /* 18: Signal */
  &Pump2Test_B.LMGP3,                  /* 19: Signal */
  &Pump2Test_B.LMGV3,                  /* 20: Signal */
  &Pump2Test_B.MFM03,                  /* 21: Signal */
  &Pump2Test_B.PT03,                   /* 22: Signal */
  &Pump2Test_B.WP03,                   /* 23: Signal */
  &Pump2Test_B.Clock,                  /* 24: Signal */
  &Pump2Test_B.Derivative,             /* 25: Signal */
  &Pump2Test_B.LookUpTable,            /* 26: Signal */
};
...
void Pump2Test_InitializeDataMapInfo(RT_MODEL_Pump2Test_T *const Pump2Test_M)
{
  /* Set C-API version */
  rtwCAPI_SetVersion(Pump2Test_M->DataMapInfo.mmi, 1);

  /* Cache static C-API data into the Real-time Model Data structure */
  rtwCAPI_SetStaticMap(Pump2Test_M->DataMapInfo.mmi, &mmiStatic);

  /* Cache static C-API logging data into the Real-time Model Data structure */
  rtwCAPI_SetLoggingStaticMap(Pump2Test_M->DataMapInfo.mmi, (NULL));

  /* Cache C-API Data Addresses into the Real-Time Model Data structure */
  rtwCAPI_SetDataAddressMap(Pump2Test_M->DataMapInfo.mmi, rtDataAddrMap);

  /* Cache C-API Data Run-Time Dimension Buffer Addresses into the Real-Time Model Data structure */
  rtwCAPI_SetVarDimsAddressMap(Pump2Test_M->DataMapInfo.mmi, rtVarDimsAddrMap);

  /* Cache the instance C-API logging pointer */
  rtwCAPI_SetInstanceLoggingInfo(Pump2Test_M->DataMapInfo.mmi, (NULL));

  /* Set reference to submodels */
  rtwCAPI_SetChildMMIArray(Pump2Test_M->DataMapInfo.mmi, (NULL));
  rtwCAPI_SetChildMMIArrayLen(Pump2Test_M->DataMapInfo.mmi, 0);
}
