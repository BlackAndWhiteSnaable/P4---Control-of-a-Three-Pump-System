...
MODEL           = Pump2Test
MODULES         = Pump2Test_capi.c Pump2Test_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_look.c rt_look1d.c rt_matrx.c rt_nonfinite.c rt_printf.c rtw_modelmap_utils.c xpc_datatype_ground.c 
MAKEFILE        = Pump2Test.mk
...
MODELLIB                  = Pump2Testlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = Pump2Test_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\Pump2Test_slrt_rtw
