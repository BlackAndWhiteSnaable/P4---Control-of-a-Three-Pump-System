...
MODEL           = firstTest
MODULES         = firstTest_capi.c firstTest_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_matrx.c rt_nonfinite.c rt_printf.c rtw_modelmap_utils.c xpc_datatype_ground.c 
MAKEFILE        = firstTest.mk
...
MASTER_ANCHOR_DIR = 
START_DIR       = C:\Users\bw_\DOCUME~1\AAU\P4\P4---C~1\OURLAB~1\DATAFR~1
...
MULTITASKING    = 0
EXT_MODE        = 0
MEX_OPT_FILE    = -f "C:\Users\bw_\AppData\Roaming\MathWorks\MATLAB\R2016b\mex_C_win64.xml"
...
MODELLIB                  = firstTestlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = firstTest_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\firstTest_slrt_rtw
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)
MATLAB_INCLUDES = $(MATLAB_INCLUDES);C:\Users\bw_\DOCUME~1\AAU\P4\P4---C~1\OURLAB~1
