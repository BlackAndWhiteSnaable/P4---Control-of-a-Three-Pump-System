...
static const rtwCAPI_Signals rtBlockSignals[] = {
   ...
   */
  { 0, 0, TARGET_STRING("ControlValve01"),
  ...
  { 24, 0, TARGET_STRING("Signal Builder/FromWs"),
    TARGET_STRING(""), 0, 0, 1, 0, 1 },

  { 25, 0, TARGET_STRING("Target_Scopes/Discrete FIR Filter"),
    TARGET_STRING("DiscreteFIR"), 0, 0, 0, 0, 2 },
...
static void* rtDataAddrMap[] = {
  ...
  &firstTest_B.CV01_input,             /* 1: Signal */
  ...
  &firstTest_B.FromWs[0],              /* 24: Signal */
  &firstTest_B.DiscreteFIR,            /* 25: Signal */
};
