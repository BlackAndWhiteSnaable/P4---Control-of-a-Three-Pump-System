...
const ConstB_Pump2Test0_1_T Pump2Test0_1_ConstB = {
  10.0                                 /* '<Root>/%2signal' */
};

/* Constant parameters (auto storage) */
const ConstP_Pump2Test0_1_T Pump2Test0_1_ConstP = {
  ...
  { 0.0, 10.0, 10.0, 20.0, 20.0, 30.0, 30.0, 40.0, 40.0, 50.0, 50.0, 60.0, 60.0,
    70.0, 70.0, 80.0, 80.0, 90.0, 90.0, 100.0, 100.0, 101.0 },

  /* Expression: sps.opv
   * Referenced by: '<S6>/Look-Up Table'
   */
  { 0.0, 0.0, 10.0, 10.0, 20.0, 20.0, 30.0, 30.0, 40.0, 40.0, 50.0, 50.0, 60.0,
    60.0, 70.0, 70.0, 80.0, 80.0, 90.0, 90.0, 100.0, 100.0 },
