...
figure('Name',['Flow Comparison run',num2str(run_num)],'NumberTitle','off','Position',[5 50 800 400])
for j = 1:numel(pump2_meas)
    ...
    plot(time,pump2_meas(j).data(:,8),style,'MarkerIndices',1500:1500:length(time),'DisplayName',name,'markers',12)
